      ...
      <div className="onb-wrap">
        ...
        <div className="onb-card">
          <div className="onb-head">
            ...
            <p>Kirjaudu Google-tililläsi aloittaaksesi</p>
          </div>
          <div className="onb-body" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
            <button
          ...
          <div className="onb-foot">
            <div style={{ fontSize: '.78rem', color: 'var(--t3)', textAlign: 'center', width: '100%' }}>
              Hetki Momentum by Hetki Company
            </div>
          </div>
        </div>
      </div>
