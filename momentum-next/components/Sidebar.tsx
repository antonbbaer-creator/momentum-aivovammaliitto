...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  projects: (
    <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="9" y1="4" x2="9" y2="20"/><line x1="15" y1="4" x2="15" y2="20"/><rect x="5" y="7" width="2.5" height="5" rx=".5" fill="currentColor" stroke="none"/><rect x="11" y="7" width="2.5" height="8" rx=".5" fill="currentColor" stroke="none"/><rect x="17" y="7" width="2.5" height="3" rx=".5" fill="currentColor" stroke="none"/></svg>
  ),
  admin: (
  ...
  const sidebarContent = (
    <>
      ...
      <nav style={{ flex: 1, padding: '.5rem 0', overflowY: 'auto' }}>
        <div className="nav-sec">Tyokalut</div>
